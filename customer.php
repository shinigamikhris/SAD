...
<h1><u>CUSTOMER</u></h1>
<br/>
<button id="myBtn" class="button">ADD CUSTOMER</button>
...
include('config.php');
include('header.php');
$query1=mysql_query("select *from customer"); 
...
{
echo "<td>".$query2['CustomerID']."</td>";
echo "<td>".$query2['CustomerName']."</td>";
echo "<td>".$query2['C_MobileNo']."</td>";

echo "<td><a href='customer_edit.php?ID=".$query2['CustomerID']."'><button type=;button' class='btn btn-success'> Edit</a></td>";
echo "<td><a href='customer_delete.php?ID=".$query2['CustomerID']."' onclick='return confirmation()'><button type=;button' class='btn btn-danger'> Delete</a></td></tr>";
}
?>
</div>
</ol>
