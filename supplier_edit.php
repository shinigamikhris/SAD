...
<tr>
<td>
Supplier: <td><input type="text" name="Supplier" value="<?php echo $query2['Supplier']; ?>" /></td>
</td>
</tr>

<tr>
<td>
MobileNo: <td><input type="text" name="S_MobileNo" value="<?php echo $query2['S_MobileNo']; ?>" /></td>
</td>
</tr>
