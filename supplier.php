...
<button id="myBtn" class="button">ADD SUPPLIER</button> 
<br><br>
<!-- The Modal -->
...
{
echo "<td>".$query2['SupplierID']."</td>";
echo "<td>".$query2['Supplier']."</td>";
echo "<td>".$query2['S_MobileNo']."</td>";
echo "<td><a href='supplier_edit.php?ID=".$query2['SupplierID']."'><button type=;button' class='btn btn-success'> Edit</a></td>";
echo "<td><a href='supplier_delete.php?ID=".$query2['SupplierID']."' onclick='return confirmation()'><button type=;button' class='btn btn-danger'> Delete</a></td></tr>";
}
?>
</div>
</ol>
